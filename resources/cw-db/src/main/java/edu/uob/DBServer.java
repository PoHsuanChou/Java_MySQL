...
public final class DBServer {
  ...
  public String handleCommand(String command) throws IOException {
    ...
    if(!parser.isTrueOrFalse()){
      String print = "[ERROR] there is something wrong with the parser : " + command;
      return print;
    }
    ...
    if(databases.containsKey(parser.getDatabaseName())) {
      ...
      String ok = "[OK] found the database";
      ...
      else if(parser.getCommandType().compareToIgnoreCase("Join") == 0) {
//        JoinCMD Join = new JoinCMD(databases,command,currentDatabase);
  }
